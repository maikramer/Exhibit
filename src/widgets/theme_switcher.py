...
@Gtk.Template(resource_path="/io/github/nokse22/Exhibit/widgets/theme_switcher.ui")
class ThemeSwitcher(Gtk.Box):
    ...
    def __init__(self, **kwargs):
        ...
        self.selected_color_scheme = settings.get_string("theme")
    ...
    def _on_color_scheme_changed(self, _widget, _paramspec):
        ...
        settings.set_string("theme", self.selected_color_scheme)
